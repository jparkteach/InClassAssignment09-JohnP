                ...
                if (user == null)
                    ...
                    userRef.addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                            Toast.makeText(MainActivity.this, dataSnapshot.getValue(message.class) + " has changed", Toast.LENGTH_SHORT).show();
                        }

                        @Override
                        public void onChildRemoved(DataSnapshot dataSnapshot) {
                            Toast.makeText(MainActivity.this, dataSnapshot.getValue(message.class) + " is removed", Toast.LENGTH_SHORT).show();
                        }
